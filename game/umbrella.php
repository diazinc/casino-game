...
<html>
    ...
    <script src="js/umbrella-controller.js" type="text/javascript"></script>
    <!-- JQUERY SLIDER -->
    ...
    <body ng-app="fortuna-rpc" ng-controller="umbrella-controller" ng-cloak>
    ...
    <div id="primary_container" class="clearfix">
		<div id="header_bg" class="clearfix">
            <div id="header_top" class="clearfix">
                ...
                <div class="clearfix" ng-controller="login-controller" ng-init="checkIfLoggedIn()">
            ...
            <div id="menu" class="clearfix">
                 <div id="main_menu_container" class="clearfix">
                    <ul id="main_menu_list">
						<li id="main_menu_1" class="selected"><a href="umbrella.php"><img class="main_menu_icon" src="img/casino/menu_ico_solid.png" width="31" height="20" alt=""/><span>{{ 'E3' | translate}}</span></a>								
            ...
            <div id="content_wrapper">
                <div id="content" class="clearfix">
                  	<div class="home_block">
                    	<h4>{{ 'E4' | translate }}</h4>
                        <div class="home_block_cta" id="home_block_img_1">
                        	
                            <div class="home_block_cta_text" id="home_cta_1"></div>
                        </div>
                        <p><span class="strong_text">{{ 'E206' | translate}}</span></p>
                        <a class="green_btn" href="casino.php">{{'E218' | translate}}</a>
                   	</div>
                    <div class="home_block">
                    	<h4>{{ 'E5' | translate}}</h4>
                        <div class="home_block_cta" id="home_block_img_2">
                            
                            <div class="home_block_cta_text" id="home_cta_2"></div>
                        </div>
                        <p><span class="strong_text">{{ 'E224' | translate}}</span></p>
                        <a class="green_btn" href="livecasino.php">{{'E218' | translate}}</a>
                   	</div>
                    <div class="home_block">
                    	<h4>{{ 'E6' | translate}}</h4>
                        <div class="home_block_cta" id="home_block_img_3">

                            <div class="home_block_cta_text" id="home_cta_3"></div>
                        </div>
                        <p><span class="strong_text" text-align="center">{{ 'E228' | translate}}</span></p>
                        <a class="green_btn" href="sportsbook.php">{{'E218' | translate}}</a>
                   	</div>
               	</div>
        	</div>
       	</div> <!--End wrapper -->
